...
# django_gdrive_crud_app/
APPS_DIR = BASE_DIR / "django_gdrive_crud_app"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "django_gdrive_crud_app.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "django_gdrive_crud_app.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Andrew Chong""", "i@andrewhchong.com")]
...
ACCOUNT_FORMS = {"signup": "django_gdrive_crud_app.users.forms.UserSignupForm"}
